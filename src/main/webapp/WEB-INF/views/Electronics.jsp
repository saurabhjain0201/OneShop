...
<body style="top-margin:20px;">
	...
	<body>
		...
		<div class="container-fluid"">
			...
			<a href="#" class="navbar-brand">OneShop</a>
			
			</div>
			<div class="collapse navbar-collapse" id="col">
				<ul class="nav navbar-nav">
					<li class="active"><a href="#">Home<span class="glyphicon glyphicon-home"></a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="index1.jsp">Sign-up</a></li>
		...
		<div class="col-12" style="margin-top:50px; margin-left:50px">
			<h1><center>Footwear</center></h1>
				<div class="thumbnails row" style="margin:40px 0 20;">
					...
					<div class="col-sm-8 col-md-2" style="margin-left:225px; margin-top:50px;">
						<div class="thumbnail" style="position:relative">
							<img alt="ImageThumbnail" src="bootstrap/images/11474967331535-PUMA-Men-Black-Brilliance-DP-Running-Shoes-3391474967331507-1_mini.jpg" class="img-responsive">
							<div class="caption">
								<h5><center><b>Puma</b></center></h5>
